...
public class e_SpellCaster {
     ...
     * @throws d_WeakSpellException if any validation requirement is not met
     */
    public static void castSpell(String spellName, int spellPower) throws d_WeakSpellException {
        // TODO
